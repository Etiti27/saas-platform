...
export function App() {
  ...
  const [refundPrev, setRefundPrev]= useState(false)
  ...
  return (
    ...
    <HeaderBar user={user} employee={employee} setSettingPrev={setSettingPrev} setRefundPrev={setRefundPrev}/>
    <Outlet user={user} employee={employee} setSettingPrev={setSettingPrev} settingPrev={settingPrev} auth={auth}/>
    <AppFooter />
...
//           <Admin user={user} employee={employee} settingPrev={settingPrev} setSettingPrev={setSettingPrev} setRefundPrev={setRefundPrev} refundPrev={refundPrev}/>
